...
function changeWndSize() {
    var style = $("div[id^='gen-tabs-panel']").attr("style");
    if (style.indexOf("overflow:hidden;") == -1) {
        $("div[id^='gen-tabs-panel']").attr("style", style + "overflow:hidden;");
    }
}

function createFrame(url) {
    var s = '<iframe name="mainFrame" scrolling="auto" frameborder="0"  src="' + url + '" style="width:99.5%;height:99.5%;"></iframe>';
    return s;
}
...
function tabCloseEven() {
    ...
    $('#mm-tabclose').click(function () {
        var currtab_title = "公司管理";//$('#mm').data("currtab");
    ...
    $('#mm-tabcloseother').click(function () {
        ...
        $('.tabs-inner span').each(function (i, n) {
            var t = $(n).text();
            if (t != "磅单查询" && $(this).parent().parent().attr("class") != "tabs-selected") {
                $('#tabs').tabs('close', t);
            }
