...
namespace Mockata.Models
{
    public class RealtimeReview
    {

        public string id { get; set; } //"55963a2cc6232708fc9c1a9e",
        public AnswerType FirstAnswer { get; set; }
        public AnswerType SecondAnswer { get; set; }
        public AnswerType ThirdAnswer { get; set; }
        ...
        public LanguageType Language { get; set; }// "en_US",
